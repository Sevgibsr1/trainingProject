          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-2">İş Birliği</h3>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                />
                <div className="p-6">
                  <h3 className="text-xl font-bold text-gray-800 mb-1">Sevgi Başar</h3>
              ...
              <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                />
                <div className="p-6">
                  <h3 className="text-xl font-bold text-gray-800 mb-1">Ahmet Yılmaz</h3>
              ...
              <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                />
                <div className="p-6">
                  <h3 className="text-xl font-bold text-gray-800 mb-1">Ayşe Kaya</h3>
