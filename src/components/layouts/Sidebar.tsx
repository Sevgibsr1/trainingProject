      ...
      >
        <div className="p-6">
          ...
          <nav className="space-y-4">
            ...
            <a onClick={() => handleNavigation('/kurslarim')} className="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-blue-100 hover:text-[#062e51] cursor-pointer">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
