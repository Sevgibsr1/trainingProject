				...
				<div className="p-6">
					...
					<nav className="space-y-4">
						<a
							...
							className="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-blue-100 hover:text-[#062e51] cursor-pointer"
						>
							{/* biome-ignore lint/a11y/noSvgWithoutTitle: <explanation> */}
							<svg
								xmlns="http://www.w3.org/2000/svg"
